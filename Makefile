...
SRC=src/
BIN=./
CFILES= $(SRC)main.c $(SRC)view.c $(SRC)machine.c $(SRC)player.c $(SRC)giuli_turn.c $(SRC)tuki_turn.c
...
tuki:	main.o view.o machine.o player.o giuli_turn.o tuki_turn.o
	gcc -o tuki main.o view.o machine.o player.o giuli_turn.o tuki_turn.o $(LIBS)		
